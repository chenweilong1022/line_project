...
//import io.renren.modules.cellar.enums.CategoryType;
//import io.renren.modules.cellar.enums.OrderType;
//import io.renren.modules.cellar.enums.SecondskillTimePeriod;
//import io.renren.modules.cellar.vo.EnumVo;
...
//        List<Map<String, Object>> maps = EnumUtil.enumToMaps(OrderType.class);
//        return R.data(maps);
//    }
//
//    /**
...
//    public R categorytypelist(){
//        List<EnumVo> enumVos = EnumUtil.enumToVo(CategoryType.values());
...
//     * 秒杀时间段
//     */
//    @RequestMapping("/secondskilltimeperiodlist")
//    public R secondskilltimeperiodlist(){
//        List<EnumVo> enumVos = EnumUtil.enumToVo(SecondskillTimePeriod.values());
//        return R.data(enumVos);
//    }
//
//}
